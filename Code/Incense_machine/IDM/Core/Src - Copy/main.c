...
//	test_nv11();
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
		...
		sprintf(s,"%02d/%02d/%d %d:%02d:%02d", Current_date.Date, Current_date.Month, 2000 + Current_date.Year, Current_time.Hours, Current_time.Minutes, Current_time.Seconds);
