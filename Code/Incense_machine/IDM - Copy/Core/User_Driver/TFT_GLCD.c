...
//		Write_Dir(0x52,0x03);
		...
		LCD_DataWrite(100);//Brightness parameter 0xff-0x00
		
		Select_Layers_Two();
		LCD_CmdWrite(0x52);//Backlight brightness setting
		LCD_DataWrite(0x23);//Brightness parameter 0xff-0x00	
		LCD_CmdWrite(0x53);//Backlight brightness setting
		LCD_DataWrite(0x00);//Brightness parameter 0xff-0x00
