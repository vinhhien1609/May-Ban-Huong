...
#define SSP_POLL_PAYOUT_OUT_SERVICE 0xC6
#define SSP_POLL_PAID_STACK_POWER_UP 0xCA
#define SSP_POLL_PAID_STORE_POWER_UP 0xCB
#define SSP_POLL_PAID_DISPENED_POWER_UP 0xCD
#define SSP_POLL_FLOAT_REMOVED 0xC7
#define SSP_POLL_FLOAT_ATTACHED 0xC8
#define SSP_POLL_BEZEL_HOLD 0xCE
...
#define SSP_POLL_INCOMPLETE_FLOAT 0xDC
