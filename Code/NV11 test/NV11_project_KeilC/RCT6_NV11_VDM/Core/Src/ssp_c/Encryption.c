...
static int32_t aes_set_key(/*@out@*/ aes_context *ctx,
                       const UINT8 *key,
                       const UINT8 *IV)
{
    // declarations
...
static int32_t aes_encrypt_16_byte_block(const aes_context *ctx,
                                     const UINT8 *plain,
                                     /*@out@*/ UINT8 *cipher)
{
    // declarations
...
static int32_t aes_decrypt_16_byte_block(const aes_context *ctx,
                                     const UINT8 *cipher,
                                     /*@out@*/ UINT8 *plain)
{
    // declarations
    ...
    UINT32 cx0, cx1, cx2, cx3; // state array columns, cx for input
    UINT32 cy0, cy1, cy2, cy3; // state array columns, cy for output
    int32_t i;                     // counter for decryption loop
